...
export function ChildGoBack() {
  return window['go']['main']['App']['ChildGoBack']();
}

export function ChildGoForward() {
  return window['go']['main']['App']['ChildGoForward']();
}

export function ChildReload() {
  return window['go']['main']['App']['ChildReload']();
}
